...
![LevelCreator窗口介绍](../dl-sample/resources/ch3_create_level_shortcut_window.png)

3. 创建成功
![创建成功](../dl-sample/resources/ch3_create_level_shortcut_success.png)

## 二.手动创建
### 1. 创建场景
1. 在Project窗口下，选择你想要创建关卡的文件夹，单击鼠标右键，选择Create -> Folder，将文件夹命名为你的关卡名称。
...
![手动创建介绍](../dl-sample/resources/ch3_create_level_manually_menu.png)

## 接下来

1.进入刚刚创建的关卡目录，看看是否创建了LevelData, Beatmapata, PathGrapherAsset以及场景文件。

2.进入场景，按照上一节"示例场景"的结构搭建场景并配置参数。
